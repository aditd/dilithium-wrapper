...
EXPORT_ATTR int crypto_sign_signature(uint8_t *sig, size_t *siglen,
...
EXPORT_ATTR int crypto_sign_verify(const uint8_t *sig, size_t siglen,
                       const uint8_t *m, size_t mlen,
                       const uint8_t *pk);

#define crypto_sign_open DILITHIUM_NAMESPACE(open)
EXPORT_ATTR int crypto_sign_open(uint8_t *m, size_t *mlen,
